...
namespace CodeGenEng.velocity.engines
{
	/// <summary>
	...
	public sealed class NVelocityFileEngine : NVelocityEngineBase, INVelocityEngine
	{
		...
		{
            this.SetProperty(RuntimeConstants_Fields.RESOURCE_LOADER, "file");
            this.SetProperty(RuntimeConstants_Fields.FILE_RESOURCE_LOADER_PATH, templateDirectory);
			this.Init();
		}
